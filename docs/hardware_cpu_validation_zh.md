...
如果暂时没有 Orin，可以先按[英文指南中的本机三终端步骤](hardware_cpu_validation.md#8-repeat-placements-or-test-locally-first)
...
生产安全认证或调度优越性证明。算法边界及参考来源见[英文指南](hardware_cpu_validation.md#design-references-and-scope)。
